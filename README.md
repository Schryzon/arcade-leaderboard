...
* **Point System Calculation**:
  ...
  * **Skill Badge** = `0.5 Points` (Every 2 badges = `1 Point`, rounded down)
  * **GEAR Bonus Milestone** = `10 Points` (if marked "Yes" in the CSV export)
  * **Total Points** = `ArcadeGames + floor(SkillBadges / 2) + (BonusMilestone ? 10 : 0)`
